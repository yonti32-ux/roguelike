...
from ..fx.world_atmosphere import ExplorationAtmosphere
try:
...
class Game:
    ...
    def __init__(self, screen: pygame.Surface, hero_class_id: str = "warrior") -> None:
        ...
        self.exploration_atmosphere = ExplorationAtmosphere()
    ...
    def toggle_inventory_overlay(self) -> None:
        ...
        play_sound("ui_open" if self.show_inventory else "ui_close")
    ...
    def toggle_character_sheet_overlay(self) -> None:
        ...
        from engine.audio import play_sound
        play_sound("ui_open" if self.show_character_sheet else "ui_close")
    ...
    def load_floor(self, floor_index: int, from_direction: Optional[str]) -> None:
        ...
        self.exploration_atmosphere.on_floor_loaded(game_map)
    ...
    def update(self, dt: float) -> None:
        ...
        if self.mode == GameMode.EXPLORATION:
            ...
            self.exploration_atmosphere.update(dt, self.current_map)
    ...
    def draw_exploration(self) -> None:
        ...
        # Ambient dungeon life (torches, dust, embers) — under entities
        self.exploration_atmosphere.draw(
            self.screen,
            self.current_map,
            camera_x,
            camera_y,
