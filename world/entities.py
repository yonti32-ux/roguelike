...
class Player(Entity):
    ...
    def draw(
        ...
        try:
            ...
            # Prefer per-class sprite (player_warrior / player_rogue / player_mage)
            class_sprite_id = getattr(self, "sprite_id", None)
            sprite_id = class_sprite_id or registry.get_entity_sprite_id(EntitySpriteType.PLAYER)
            ...
            # Fall back to generic player.png if class sprite is missing
            if (sprite is None or sprite_manager.is_sprite_fallback(sprite)) and class_sprite_id:
